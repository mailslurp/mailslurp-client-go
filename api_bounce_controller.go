...
@return Bounce
*/
func (a *BounceControllerApiService) GetBouncedEmail(ctx _context.Context, id string) (Bounce, *_nethttp.Response, error) {
	var (
...
*/
func (a *BounceControllerApiService) GetBouncedRecipient(ctx _context.Context, id string) (BounceRecipient, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  BounceRecipient
	)

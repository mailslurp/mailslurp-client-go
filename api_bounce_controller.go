...
/*
GetTenantReputationFindings Get SES tenant reputation findings
...
*/
func (a *BounceControllerApiService) GetTenantReputationFindings(ctx _context.Context, localVarOptionals *GetTenantReputationFindingsOpts) (TenantReputationFindingsDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  TenantReputationFindingsDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bounce/tenant-findings"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	if localVarOptionals != nil && localVarOptionals.AccountRegion.IsSet() {
		localVarQueryParams.Add("accountRegion", parameterToString(localVarOptionals.AccountRegion.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
/*
GetTenantReputationStatusSummary Get SES tenant status summary
...
*/
func (a *BounceControllerApiService) GetTenantReputationStatusSummary(ctx _context.Context, localVarOptionals *GetTenantReputationStatusSummaryOpts) (TenantReputationStatusSummaryDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  TenantReputationStatusSummaryDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/bounce/tenant-status"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

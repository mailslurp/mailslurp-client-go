...
@return Inbox
*/
func (a *CommonActionsControllerApiService) CreateNewEmailAddress(ctx _context.Context, useDomainPool bool) (Inbox, *_nethttp.Response, error) {
	var (
	...
	localVarQueryParams.Add("useDomainPool", parameterToString(useDomainPool, ""))
...
@return Inbox
*/
func (a *CommonActionsControllerApiService) CreateNewEmailAddress1(ctx _context.Context, useDomainPool bool) (Inbox, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string

...
/*
SendEmailQuery Send an email using query parameters
...
func (a *CommonActionsControllerApiService) SendEmailQuery(ctx _context.Context, to string, localVarOptionals *SendEmailQueryOpts) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/sendEmailQuery"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	if localVarOptionals != nil && localVarOptionals.SenderId.IsSet() {
		localVarQueryParams.Add("senderId", parameterToString(localVarOptionals.SenderId.Value(), ""))
	}

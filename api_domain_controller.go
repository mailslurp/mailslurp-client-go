...
/*
AddDomainWildcardCatchAll Add catch all wild card inbox to domain
...
func (a *DomainControllerApiService) AddDomainWildcardCatchAll(ctx _context.Context, id string) (DomainDto, *_nethttp.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/domains/{id}/wildcard"
...
/*
GetAvailableDomainRegions Get all usable domains with account region status
...
func (a *DomainControllerApiService) GetAvailableDomainRegions(ctx _context.Context, localVarOptionals *GetAvailableDomainRegionsOpts) (DomainRegionGroupsDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DomainRegionGroupsDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/domains/available-domain-regions"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetAvailableDomains Get all usable domains
...
func (a *DomainControllerApiService) GetAvailableDomains(ctx _context.Context, localVarOptionals *GetAvailableDomainsOpts) (DomainGroupsDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DomainGroupsDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/domains/available-domains"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *DomainControllerApiService) GetDomain(ctx _context.Context, id string, localVarOptionals *GetDomainOpts) (DomainDto, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.CheckForErrors.IsSet() {
		localVarQueryParams.Add("checkForErrors", parameterToString(localVarOptionals.CheckForErrors.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
/*
GetDomainIssues Get domain issues
...
func (a *DomainControllerApiService) GetDomainIssues(ctx _context.Context) (DomainIssuesDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  DomainIssuesDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/domains/issues"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetDomainWildcardCatchAllInbox Get catch all wild card inbox for domain
...
/*
GetMailSlurpDomains Get MailSlurp domains
...
func (a *DomainControllerApiService) GetMailSlurpDomains(ctx _context.Context, localVarOptionals *GetMailSlurpDomainsOpts) (DomainGroupsDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/domains/mailslurp-domains"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *DomainControllerApiService) UpdateDomain(ctx _context.Context, id string, updateDomainOptions UpdateDomainOptions) (DomainDto, *_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &updateDomainOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

...
@return DomainDto
*/
func (a *DomainControllerApiService) UpdateDomain(ctx _context.Context, id string, updateDomainDto UpdateDomainOptions) (DomainDto, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &updateDomainDto
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

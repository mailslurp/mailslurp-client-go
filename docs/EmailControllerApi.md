...
[**GetEmailHTMLQuery**](EmailControllerApi.md#GetEmailHTMLQuery) | **Post** /emails/{emailId}/html-query | Parse and return text from an email, stripping HTML and decoding encoded characters
[**GetEmailTextLines**](EmailControllerApi.md#GetEmailTextLines) | **Post** /emails/{emailId}/text | Parse and return text from an email, stripping HTML and decoding encoded characters
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**emailId** | [**string**](.md)| ID of email to perform HTML query on | 
...
> EmailTextLinesResult GetEmailTextLines(ctx, decodeHtmlEntities, emailId)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**decodeHtmlEntities** | **bool**| Decode HTML entities | 
**emailId** | [**string**](.md)| ID of email to fetch text for | 

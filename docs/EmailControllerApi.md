...
[**GetOrganizationEmailsPaginated**](EmailControllerApi.md#GetOrganizationEmailsPaginated) | **Get** /emails/organization | Get all organization emails
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxIds** | [**optional.Interface of []string**](string.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | 
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inboxId** | [**optional.Interface of string**](.md)| ID of the inbox you want to get the latest email from | 

...
[**GetGravatarUrlForEmailAddress**](EmailControllerApi#GetGravatarUrlForEmailAddress) | **Get** /emails/gravatarFor | Get gravatar url for email address
...
[**MarkAsRead**](EmailControllerApi#MarkAsRead) | **Patch** /emails/{emailId}/read | Mark an email as read
...
> SendEmailSourceOptional(ctx, optional)

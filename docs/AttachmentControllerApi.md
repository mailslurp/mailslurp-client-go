...
> PageAttachmentEntity GetAttachments1(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetAttachments1Opts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetAttachments1Opts struct
...
> []string UploadAttachmentBytes(ctx, requestBody, optional)
 ...
 **inlineObject** | [**optional.Interface of InlineObject**](InlineObject)|  | 

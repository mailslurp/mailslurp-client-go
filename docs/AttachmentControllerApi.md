...
[**ExtractAttachmentText**](AttachmentControllerApi#ExtractAttachmentText) | **Post** /attachments/{attachmentId}/text | Extract text from an attachment
...
> ExtractAttachmentTextResult ExtractAttachmentText(ctx, attachmentId, optional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**attachmentId** | **string**| ID of attachment | 
 **optional** | ***ExtractAttachmentTextOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ExtractAttachmentTextOpts struct


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **extractAttachmentTextOptions** | [**optional.Interface of ExtractAttachmentTextOptions**](ExtractAttachmentTextOptions)|  | 
 ...
 **inlineObject2** | [**optional.Interface of InlineObject2**](InlineObject2)|  | 

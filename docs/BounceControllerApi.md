...
[**GetTenantReputationFindings**](BounceControllerApi#GetTenantReputationFindings) | **Get** /bounce/tenant-findings | Get SES tenant reputation findings
[**GetTenantReputationStatusSummary**](BounceControllerApi#GetTenantReputationStatusSummary) | **Get** /bounce/tenant-status | Get SES tenant status summary
...
> PageReputationItems GetReputationItems(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetReputationItemsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetReputationItemsOpts struct
...
> TenantReputationFindingsDto GetTenantReputationFindings(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetTenantReputationFindingsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetTenantReputationFindingsOpts struct


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **accountRegion** | **optional.String**| Optional account region filter | 
...
> TenantReputationStatusSummaryDto GetTenantReputationStatusSummary(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetTenantReputationStatusSummaryOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetTenantReputationStatusSummaryOpts struct

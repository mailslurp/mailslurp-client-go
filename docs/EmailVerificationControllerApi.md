...
[**GetEmailIntelligence**](EmailVerificationControllerApi#GetEmailIntelligence) | **Post** /email-verification/intelligence | Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
...
> EmailIntelligenceListResult GetEmailIntelligence(ctx, emailIntelligenceOptions)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**emailIntelligenceOptions** | [**EmailIntelligenceOptions**](EmailIntelligenceOptions)|  | 

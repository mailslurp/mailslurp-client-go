...
**UserId** | Pointer to **string** | ID of user that inbox belongs to | 
...
**LocalPart** | Pointer to **string** | Local part of email addresses before the @ symbol | [optional] 
**Domain** | Pointer to **string** | Domain name of the email address | [optional] 

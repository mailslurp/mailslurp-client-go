...
[**GetSmsCodes**](SmsControllerApi#GetSmsCodes) | **Post** /sms/{smsId}/codes | Extract verification codes from an SMS
...
[**MarkAllSmsAsRead**](SmsControllerApi#MarkAllSmsAsRead) | **Patch** /sms/read | Mark all SMS messages as read or unread
[**MarkSmsAsRead**](SmsControllerApi#MarkSmsAsRead) | **Patch** /sms/{smsId}/read | Mark an SMS as read or unread
...
> ExtractCodesResult GetSmsCodes(ctx, smsId, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**smsId** | [**string**]()| ID of SMS to extract codes from | 
 **optional** | ***GetSmsCodesOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetSmsCodesOpts struct
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***MarkAllSmsAsReadOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a MarkAllSmsAsReadOpts struct


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **read** | **optional.Bool**|  | [default to true]
 **phoneNumberId** | [**optional.Interface of string**]()|  | 
...
> SmsDto MarkSmsAsRead(ctx, smsId, optional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**smsId** | [**string**]()|  | 
 **optional** | ***MarkSmsAsReadOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a MarkSmsAsReadOpts struct

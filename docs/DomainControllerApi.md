...
[**GetAvailableDomainRegions**](DomainControllerApi#GetAvailableDomainRegions) | **Get** /domains/available-domain-regions | Get all usable domains with account region status
...
> DomainRegionGroupsDto GetAvailableDomainRegions(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetAvailableDomainRegionsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetAvailableDomainRegionsOpts struct
...
[**DomainRegionGroupsDto**](DomainRegionGroupsDto)

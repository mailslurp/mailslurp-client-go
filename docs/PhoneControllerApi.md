...
> PhoneNumberDto AddPhoneNumberTags(ctx, phoneNumberId, phoneNumberTagsOptions)
...
> []string GetPhoneNumberTags(ctx, phoneNumberId)
 ...
 **tag** | [**optional.Interface of []string**](string)| Optional tags to filter by. A phone must include all provided tags | 
...
> []string GetPhoneTags(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetPhoneTagsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetPhoneTagsOpts struct
...
> PhoneNumberDto RemovePhoneNumberTags(ctx, phoneNumberId, phoneNumberTagsOptions)
...
> PhoneNumberDto SetPhoneNumberTags(ctx, phoneNumberId, phoneNumberTagsOptions)

...
**Field** | Pointer to **string** | Field to match against to trigger inbox replier for inbound email | [optional] 
**Match** | Pointer to **string** | String or wildcard style match for field specified when evaluating reply rules. Use &#x60;*&#x60; to match anything. | [optional] 

...
**DomainId** | Pointer to **string** | Custom domain ID to use when generating alias email addresses | [optional] 
**VerifyEmailAddress** | Pointer to **bool** | Whether to verify the masked email address exists before sending an email to it | [optional] 

...
[**GetOrCreateInboxPlusAddress**](InboxControllerApi#GetOrCreateInboxPlusAddress) | **Post** /inboxes/{inboxId}/plus-addresses/get-or-create | Get or create a plus address by full address
[**GetOrCreatePlusAddressByFullAddress**](InboxControllerApi#GetOrCreatePlusAddressByFullAddress) | **Post** /inboxes/get-or-create-plus-address | Get or create a plus address by full address without inbox ID
...
[**ImportEmailIntoInbox**](InboxControllerApi#ImportEmailIntoInbox) | **Post** /inboxes/{inboxId}/emails/import | Import email into inbox from base64 MIME
[**ImportEmailIntoInboxBytes**](InboxControllerApi#ImportEmailIntoInboxBytes) | **Post** /inboxes/{inboxId}/emails/import/raw | Import email into inbox from raw MIME bytes
[**ImportEmailIntoInboxMultipart**](InboxControllerApi#ImportEmailIntoInboxMultipart) | **Post** /inboxes/{inboxId}/emails/import/multipart | Import email into inbox from multipart EML upload
...
> RulesetDto CreateInboxRuleset(ctx, inboxId, createRulesetOptions)
 ...
 **search** | **optional.String**| Optionally filter by search words partial matching name and email address | 
...
> PlusAddressDto GetOrCreateInboxPlusAddress(ctx, inboxId, fullAddress)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**inboxId** | [**string**]()| ID of the inbox you want to target | 
**fullAddress** | **string**| Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; | 
...
> PlusAddressDto GetOrCreatePlusAddressByFullAddress(ctx, fullAddress)
...
> Email ImportEmailIntoInbox(ctx, inboxId, importEmailOptions)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**inboxId** | [**string**]()|  | 
**importEmailOptions** | [**ImportEmailOptions**](ImportEmailOptions)|  | 
...
> Email ImportEmailIntoInboxBytes(ctx, inboxId, body, optional)
...
**inboxId** | [**string**]()|  | 
**body** | **string**|  | 
 **optional** | ***ImportEmailIntoInboxBytesOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ImportEmailIntoInboxBytesOpts struct
 ...
 **runPipeline** | **optional.Bool**|  | [default to false]
 **overrideMessageId** | **optional.Bool**|  | [default to true]
...
- **Content-Type**: application/octet-stream, message/rfc822
- **Accept**: */*
...
> Email ImportEmailIntoInboxMultipart(ctx, inboxId, file, optional)
 ...
 **optional** | ***ImportEmailIntoInboxMultipartOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a ImportEmailIntoInboxMultipartOpts struct
...
> PageRulesetDto ListInboxRulesets(ctx, inboxId, optional)

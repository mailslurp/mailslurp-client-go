...
> WebhookDto CreateWebhookForAITransformer(ctx, transformerId, createWebhookOptions)
 ...
 **health** | **optional.String**| Filter by webhook health | 
...
> PageWebhookEndpointProjection GetAllWebhookEndpoints(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***GetAllWebhookEndpointsOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a GetAllWebhookEndpointsOpts struct
 ...
 **aiTransformerId** | [**optional.Interface of string**]()| AI Transformer ID | 
 ...
 **since** | **optional.Time**| Filter by created at after the given timestamp | 
 **inboxId** | [**optional.Interface of string**]()| Filter by inboxId | 
 **aiTransformerId** | [**optional.Interface of string**]()| Filter by aiTransformerId | 
 **phoneId** | [**optional.Interface of string**]()| Filter by phoneId | 
 **before** | **optional.Time**| Filter by created at before the given timestamp | 
 **health** | **optional.String**| Filter by webhook health | 
 **eventType** | **optional.String**| Optional event type | 
 **url** | **optional.String**| Optional url endpoint filter | 
 **eventTypeSource** | **optional.String**| Webhook source type category such as phone, inbox, aiTranformer | 
 **includeAccountWide** | **optional.Bool**| Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters | 
 ...
 **health** | **optional.String**| Filter by webhook health | 
 **eventType** | **optional.String**| Optional event type | 
 **includeAccountWide** | **optional.Bool**| Include account scope inbox webhooks | 
 ...
 **searchFilter** | **optional.String**| Optional search filter | 
 **health** | **optional.String**| Filter by webhook health | 
 **includeAccountWide** | **optional.Bool**| Include account scope phone webhooks | 
...
> WebhookNewAiTransformResultPayload GetTestWebhookPayloadNewAITransformResult(ctx, )
...
> []WebhookProjection GetWebhooks(ctx, inboxId, optional)
...
> WebhookDto UpdateWebhook(ctx, webhookId, createWebhookOptions, optional)
 ...
 **aiTransformerId** | [**optional.Interface of string**]()|  | 

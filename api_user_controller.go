...
/*
CreateOrUpdateInboxRetentionPolicyForAccount Method for CreateOrUpdateInboxRetentionPolicyForAccount
...
func (a *UserControllerApiService) CreateOrUpdateInboxRetentionPolicyForAccount(ctx _context.Context, createInboxRetentionPolicyForAccountOptions CreateInboxRetentionPolicyForAccountOptions) (InboxRetentionPolicyDto, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  InboxRetentionPolicyDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/user/inbox-retention-policies/account"
	...
	// body params
	localVarPostBody = &createInboxRetentionPolicyForAccountOptions
	if ctx != nil {
...
/*
DeleteInboxRetentionPolicyForAccount Method for DeleteInboxRetentionPolicyForAccount
...
*/
func (a *UserControllerApiService) GetEntityAutomations(ctx _context.Context, localVarOptionals *GetEntityAutomationsOpts) (PageEntityAutomationItems, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageEntityAutomationItems
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/user/automations"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *UserControllerApiService) GetEntityEvents(ctx _context.Context, localVarOptionals *GetEntityEventsOpts) (PageEntityEventItems, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageEntityEventItems
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/user/events"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
*/
func (a *UserControllerApiService) GetEntityFavorites(ctx _context.Context, localVarOptionals *GetEntityFavoritesOpts) (PageEntityFavouriteItems, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageEntityFavouriteItems
	)
...
/*
GetInboxRetentionPolicyForAccount Method for GetInboxRetentionPolicyForAccount
...
func (a *UserControllerApiService) GetInboxRetentionPolicyForAccount(ctx _context.Context) (InboxRetentionPolicyOptionalDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InboxRetentionPolicyOptionalDto
	)

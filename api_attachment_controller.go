...
/*
ExtractAttachmentText Extract text from an attachment
...
func (a *AttachmentControllerApiService) ExtractAttachmentText(ctx _context.Context, attachmentId string, localVarOptionals *ExtractAttachmentTextOpts) (ExtractAttachmentTextResult, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ExtractAttachmentTextResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/attachments/{attachmentId}/text"
	localVarPath = strings.Replace(localVarPath, "{"+"attachmentId"+"}", _neturl.QueryEscape(parameterToString(attachmentId, "")) , -1)
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.ExtractAttachmentTextOptions.IsSet() {
		localVarOptionalExtractAttachmentTextOptions, localVarOptionalExtractAttachmentTextOptionsok := localVarOptionals.ExtractAttachmentTextOptions.Value().(ExtractAttachmentTextOptions)
		if !localVarOptionalExtractAttachmentTextOptionsok {
			return localVarReturnValue, nil, reportError("extractAttachmentTextOptions should be ExtractAttachmentTextOptions")
		}
		localVarPostBody = &localVarOptionalExtractAttachmentTextOptions
	}

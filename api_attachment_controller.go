 ...
 * @param "String_" (optional.String) -  Optional contentType for file. For instance `application/pdf`
...
func (a *AttachmentControllerApiService) UploadAttachmentBytes(ctx _context.Context, localVarOptionals *UploadAttachmentBytesOpts) ([]string, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.String_.IsSet() {
		localVarQueryParams.Add("String", parameterToString(localVarOptionals.String_.Value(), ""))
	}

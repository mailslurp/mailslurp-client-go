...
/*
DownloadAttachmentAsBase64Encoded Get email attachment as base64 encoded string (alternative to binary responses). To read the content decode the Base64 encoded contents.

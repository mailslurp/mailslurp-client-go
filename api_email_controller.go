...
/*
CanSend Check if email can be sent and options are valid.
...
/*
CheckEmailBody Detect broken links, spelling, and images in email content
...
/*
CheckEmailBodyFeatureSupport Show which mail clients support the HTML and CSS features used in an email body.
...
/*
CheckEmailClientSupport Show which email programs and devices support the features used in an email body.
...
/*
GetEmailAttachments Get all email attachment metadata. Metadata includes name and size of attachments.
...
/*
GetEmailContentPartContent Get email content part by content type raw response
...
/*
GetEmailHTMLJson Get email content as HTML in JSON wrapper. For fetching entity decoded HTML content
...
/*
GetEmailSummary Get email data including headers but not body. Expects email to exist by ID. For emails that may not have arrived yet use the WaitForController.
...
/*
GetEmailThread Return email thread information. Use items endpoints to get messages for thread.
...
/*
GetEmailThreadItems Return email thread items.
...
/*
GetEmailThreads Return email threads in paginated form
 ...
 * @param "HtmlSelector" (optional.Interface of string) -  Optional inbox filter
...
/*
GetGravatarUrlForEmailAddress Method for GetGravatarUrlForEmailAddress

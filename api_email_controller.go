...
func (a *EmailControllerApiService) GetEmailHTMLQuery(ctx _context.Context, emailId string, htmlSelector string) (EmailTextLinesResult, *_nethttp.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"htmlSelector"+"}", _neturl.QueryEscape(parameterToString(htmlSelector, "")) , -1)
...
@return EmailTextLinesResult
*/
func (a *EmailControllerApiService) GetEmailTextLines(ctx _context.Context, decodeHtmlEntities bool, emailId string) (EmailTextLinesResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath = strings.Replace(localVarPath, "{"+"decodeHtmlEntities"+"}", _neturl.QueryEscape(parameterToString(decodeHtmlEntities, "")) , -1)

...
*/
func (a *EmailControllerApiService) SendEmailSourceOptional(ctx _context.Context, inboxId string, sendEmailOptions SendEmailOptions, localVarOptionals *SendEmailSourceOptionalOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string

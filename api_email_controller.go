...
/*
DownloadAttachmentBase64 Get email attachment as base64 encoded string alternative to binary responses. Decode the `base64FileContents` as a `utf-8` encoded string or array of bytes depending on the `contentType`.
...
/*
GetAttachments1 Get all email attachment metadata. Metadata includes name and attachment size.
...
/*
GetEmailsPaginated Get all emails in all inboxes. Email API list all.

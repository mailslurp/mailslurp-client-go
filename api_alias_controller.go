...
func (a *AliasControllerApiService) GetAliasThreads(ctx _context.Context, aliasId string, localVarOptionals *GetAliasThreadsOpts) (PageAliasThreadProjection, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageAliasThreadProjection
	)
...
*/
func (a *AliasControllerApiService) GetThread(ctx _context.Context, threadId string) (AliasThreadProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AliasThreadProjection
	)
...
@return PageAliasThreadProjection
*/
func (a *AliasControllerApiService) GetThreadsPaginated(ctx _context.Context, localVarOptionals *GetThreadsPaginatedOpts) (PageAliasThreadProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string

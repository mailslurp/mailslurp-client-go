...
@return SentEmailDto
*/
func (a *AliasControllerApiService) ReplyToEmail(ctx _context.Context, aliasId string, emailId string, replyToAliasEmailOptions ReplyToAliasEmailOptions) (SentEmailDto, *_nethttp.Response, error) {
	var (
...
// SendAliasEmailOpts Optional parameters for the method 'SendAliasEmail'
type SendAliasEmailOpts struct {
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param aliasId aliasId
 * @param optional nil or *SendAliasEmailOpts - Optional Parameters:
 * @param "SendEmailOptions" (optional.Interface of SendEmailOptions) -  Options for the email to be sent
@return SentEmailDto
*/
func (a *AliasControllerApiService) SendAliasEmail(ctx _context.Context, aliasId string, localVarOptionals *SendAliasEmailOpts) (SentEmailDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string

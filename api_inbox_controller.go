...
@return SentEmail
*/
func (a *InboxControllerApiService) SendEmailAndConfirm(ctx _context.Context, inboxId string, localVarOptionals *SendEmailAndConfirmOpts) (SentEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string

 ...
 * @param "AllowTeamAccess" (optional.Bool) -  Grant team access to this inbox and the emails that belong to it for team members of your organization.
...
*/
func (a *InboxControllerApiService) CreateInboxRuleset(ctx _context.Context, inboxId string, createInboxRulesetOptions CreateInboxRulesetOptions) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param "TeamAccess" (optional.Bool) -  Optionally filter by team access. Defaults to false so organization inboxes are not included
...
/*
GetInboxes List Inboxes and email eddresses
 ...
 * @param "Sort" (optional.String) -  Optional createdAt sort direction ASC or DESC
*/
func (a *InboxControllerApiService) ListInboxRulesets(ctx _context.Context, inboxId string, localVarOptionals *ListInboxRulesetsOpts) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string

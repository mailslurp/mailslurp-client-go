...
/*
CancelScheduledJob Cancel a scheduled email job
...
func (a *InboxControllerApiService) CancelScheduledJob(ctx _context.Context, jobId string) (ScheduledJobDto, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ScheduledJobDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/scheduled-jobs/{jobId}"
...
func (a *InboxControllerApiService) CreateInbox(ctx _context.Context, localVarOptionals *CreateInboxOpts) (InboxDto, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.UseShortAddress.IsSet() {
		localVarQueryParams.Add("useShortAddress", parameterToString(localVarOptionals.UseShortAddress.Value(), ""))
	}
...
/*
DeleteAllInboxesByDescription Delete inboxes by description
...
func (a *InboxControllerApiService) DeleteAllInboxesByDescription(ctx _context.Context, description string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/by-description"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if strlen(description) < 1 {
		return nil, reportError("description must have at least 1 elements")
	}
...
/*
DeleteAllInboxesByName Delete inboxes by name
...
func (a *InboxControllerApiService) DeleteAllInboxesByName(ctx _context.Context, name string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/by-name"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if strlen(name) < 1 {
...
/*
DeleteAllInboxesByTag Delete inboxes by tag
...
func (a *InboxControllerApiService) DeleteAllInboxesByTag(ctx _context.Context, tag string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/by-tag"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if strlen(tag) < 1 {
		return nil, reportError("tag must have at least 1 elements")
	}
...
func (a *InboxControllerApiService) DoesInboxExist(ctx _context.Context, emailAddress string, localVarOptionals *DoesInboxExistOpts) (InboxExistsDto, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.AllowCatchAll.IsSet() {
		localVarQueryParams.Add("allowCatchAll", parameterToString(localVarOptionals.AllowCatchAll.Value(), ""))
	}
...
/*
DoesInboxHaveAutomations Does inbox have automations
...
func (a *InboxControllerApiService) DoesInboxHaveAutomations(ctx _context.Context) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/automations"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *InboxControllerApiService) GetAllInboxes(ctx _context.Context, localVarOptionals *GetAllInboxesOpts) (PageInboxProjection, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.InboxFunction.IsSet() {
		localVarQueryParams.Add("inboxFunction", parameterToString(localVarOptionals.InboxFunction.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.DomainId.IsSet() {
		localVarQueryParams.Add("domainId", parameterToString(localVarOptionals.DomainId.Value(), ""))
	}
...
/*
GetAllInboxesOffsetPaginated List All Inboxes Offset Paginated
List inboxes in paginated form. The results are available on the &#x60;content&#x60; property of the returned object. This method allows for page index (zero based), page size (how many results to return), and a sort direction (based on createdAt time). You Can also filter by whether an inbox is favorited or use email address pattern. This method is the recommended way to query inboxes. The alternative &#x60;getInboxes&#x60; method returns a full list of inboxes but is limited to 100 results.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InboxControllerApiService) GetAllInboxesOffsetPaginated(ctx _context.Context, localVarOptionals *GetAllInboxesOffsetPaginatedOpts) (PageInboxProjection, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/offset-paginated"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetAllPlusAddresses Get all sub address plus address aliases for an inbox
...
*/
func (a *InboxControllerApiService) GetAllPlusAddresses(ctx _context.Context, localVarOptionals *GetAllPlusAddressesOpts) (PagePlusAddressProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagePlusAddressProjection
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/plus-addresses"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetImapAccess Method for GetImapAccess
...
func (a *InboxControllerApiService) GetImapAccess(ctx _context.Context, localVarOptionals *GetImapAccessOpts) (ImapAccessDetails, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ImapAccessDetails
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/imap-access"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetImapSmtpAccessEnv Method for GetImapSmtpAccessEnv
...
func (a *InboxControllerApiService) GetImapSmtpAccessEnv(ctx _context.Context, localVarOptionals *GetImapSmtpAccessEnvOpts) (string, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/imap-smtp-access/env"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetImapSmtpAccessServers Method for GetImapSmtpAccessServers
...
func (a *InboxControllerApiService) GetImapSmtpAccessServers(ctx _context.Context) (ImapSmtpAccessServers, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ImapSmtpAccessServers
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/imap-smtp-access/servers"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *InboxControllerApiService) GetInboxByEmailAddress(ctx _context.Context, emailAddress string) (InboxByEmailAddressResult, *_nethttp.Response, error) {
	...
	if strlen(emailAddress) < 1 {
		return localVarReturnValue, nil, reportError("emailAddress must have at least 1 elements")
	}
...
/*
GetInboxPlusAddress Get sub address plus address for an inbox
...
func (a *InboxControllerApiService) GetInboxPlusAddress(ctx _context.Context, plusAddressId string, inboxId string) (PlusAddressDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PlusAddressDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/plus-addresses/{plusAddressId}"
	localVarPath = strings.Replace(localVarPath, "{"+"plusAddressId"+"}", _neturl.QueryEscape(parameterToString(plusAddressId, "")) , -1)
...
/*
GetInboxPlusAddressById Get sub address plus address by ID
Returns a plus address object based on emails that used the inbox address with a +xyz alias.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param plusAddressId ID of the plus address you want to fetch
...
func (a *InboxControllerApiService) GetInboxPlusAddressById(ctx _context.Context, plusAddressId string, localVarOptionals *GetInboxPlusAddressByIdOpts) (PlusAddressDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/plus-addresses/{plusAddressId}"
	localVarPath = strings.Replace(localVarPath, "{"+"plusAddressId"+"}", _neturl.QueryEscape(parameterToString(plusAddressId, "")) , -1)
...
/*
GetInboxPlusAddressEmails Get emails for a given inbox plus address
...
func (a *InboxControllerApiService) GetInboxPlusAddressEmails(ctx _context.Context, plusAddress string, inboxId string, localVarOptionals *GetInboxPlusAddressEmailsOpts) (PageEmailPreview, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/plus-addresses/emails"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
	...
	localVarQueryParams.Add("plusAddress", parameterToString(plusAddress, ""))
	if localVarOptionals != nil && localVarOptionals.Page.IsSet() {
		localVarQueryParams.Add("page", parameterToString(localVarOptionals.Page.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Size.IsSet() {
...
/*
GetInboxPlusAddressEmailsForPlusAddressId Get emails for a given inbox plus address
Returns paginated list of all emails for a given plus alias addresses found for an inbox based on received emails that used the inbox address with a +xyz alias.
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
func (a *InboxControllerApiService) GetInboxPlusAddressEmailsForPlusAddressId(ctx _context.Context, plusAddressId string, inboxId string, localVarOptionals *GetInboxPlusAddressEmailsForPlusAddressIdOpts) (PageEmailPreview, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails"
	localVarPath = strings.Replace(localVarPath, "{"+"plusAddressId"+"}", _neturl.QueryEscape(parameterToString(plusAddressId, "")) , -1)
...
/*
GetInboxPlusAddresses Get sub address plus address aliases for an inbox
...
func (a *InboxControllerApiService) GetInboxPlusAddresses(ctx _context.Context, inboxId string, localVarOptionals *GetInboxPlusAddressesOpts) (PagePlusAddressProjection, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/plus-addresses"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
...
func (a *InboxControllerApiService) GetInboxSentCount(ctx _context.Context, inboxId string) (CountDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/sent/count"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
...
/*
GetInboxTagsPaginated Get inbox tags paginated
...
func (a *InboxControllerApiService) GetInboxTagsPaginated(ctx _context.Context, localVarOptionals *GetInboxTagsPaginatedOpts) (PageInboxTags, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageInboxTags
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/tags/paginated"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *InboxControllerApiService) GetInboxes(ctx _context.Context, localVarOptionals *GetInboxesOpts) ([]InboxDto, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.ExcludeCatchAllInboxes.IsSet() {
		localVarQueryParams.Add("excludeCatchAllInboxes", parameterToString(localVarOptionals.ExcludeCatchAllInboxes.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Before.IsSet() {
		localVarQueryParams.Add("before", parameterToString(localVarOptionals.Before.Value(), ""))
	}
...
/*
GetInboxesByTag Get inboxes for a tag
...
func (a *InboxControllerApiService) GetInboxesByTag(ctx _context.Context, tag string, localVarOptionals *GetInboxesByTagOpts) (PageInboxProjection, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/tags/inboxes"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetOrCreateInboxPlusAddress Get or create a plus address by full address
...
func (a *InboxControllerApiService) GetOrCreateInboxPlusAddress(ctx _context.Context, inboxId string, fullAddress string) (PlusAddressDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/plus-addresses/get-or-create"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
	...
	if strlen(fullAddress) < 1 {
		return localVarReturnValue, nil, reportError("fullAddress must have at least 1 elements")
	}

	localVarQueryParams.Add("fullAddress", parameterToString(fullAddress, ""))
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
/*
GetOrCreatePlusAddressByFullAddress Get or create a plus address by full address without inbox ID
...
func (a *InboxControllerApiService) GetOrCreatePlusAddressByFullAddress(ctx _context.Context, fullAddress string) (PlusAddressDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/get-or-create-plus-address"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if strlen(fullAddress) < 1 {
...
/*
GetOutboxes List all inboxes with sent emails
...
@return PageInboxProjection
*/
func (a *InboxControllerApiService) GetOutboxes(ctx _context.Context, localVarOptionals *GetOutboxesOpts) (PageInboxProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/outboxes"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetScheduledJob Get a scheduled email job
...
/*
GetSmtpAccess Method for GetSmtpAccess
...
func (a *InboxControllerApiService) GetSmtpAccess(ctx _context.Context, localVarOptionals *GetSmtpAccessOpts) (SmtpAccessDetails, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  SmtpAccessDetails
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/smtp-access"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
ImportEmailIntoInbox Import email into inbox from base64 MIME
...
func (a *InboxControllerApiService) ImportEmailIntoInbox(ctx _context.Context, inboxId string, importEmailOptions ImportEmailOptions) (Email, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/emails/import"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
	...
	// body params
	localVarPostBody = &importEmailOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
ImportEmailIntoInboxBytes Import email into inbox from raw MIME bytes
...
func (a *InboxControllerApiService) ImportEmailIntoInboxBytes(ctx _context.Context, inboxId string, body string, localVarOptionals *ImportEmailIntoInboxBytesOpts) (Email, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/emails/import/raw"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
	...
	if localVarOptionals != nil && localVarOptionals.RunPipeline.IsSet() {
		localVarQueryParams.Add("runPipeline", parameterToString(localVarOptionals.RunPipeline.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.OverrideMessageId.IsSet() {
		localVarQueryParams.Add("overrideMessageId", parameterToString(localVarOptionals.OverrideMessageId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/octet-stream", "message/rfc822"}
...
/*
ImportEmailIntoInboxMultipart Import email into inbox from multipart EML upload
...
func (a *InboxControllerApiService) ImportEmailIntoInboxMultipart(ctx _context.Context, inboxId string, file *os.File, localVarOptionals *ImportEmailIntoInboxMultipartOpts) (Email, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/emails/import/multipart"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
...
/*
IsEmailAddressAvailable Is email address available
...
func (a *InboxControllerApiService) IsEmailAddressAvailable(ctx _context.Context, emailAddress string) (EmailAvailableResult, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  EmailAvailableResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/available"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
SearchInboxes Search all inboxes and return matching inboxes
...
func (a *InboxControllerApiService) SearchInboxes(ctx _context.Context, searchInboxesOptions SearchInboxesOptions) (PageInboxProjection, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/search"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &searchInboxesOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
UpdateImapAccess Method for UpdateImapAccess
...
func (a *InboxControllerApiService) UpdateImapAccess(ctx _context.Context, updateImapAccessOptions UpdateImapAccessOptions, localVarOptionals *UpdateImapAccessOpts) (*_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &updateImapAccessOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
UpdateSmtpAccess Method for UpdateSmtpAccess
...
func (a *InboxControllerApiService) UpdateSmtpAccess(ctx _context.Context, updateSmtpAccessOptions UpdateSmtpAccessOptions, localVarOptionals *UpdateSmtpAccessOpts) (*_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &updateSmtpAccessOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

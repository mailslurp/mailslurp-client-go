 ...
 * @param "Favourite" (optional.Bool) -  Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering
 * @param "Name" (optional.String) -  Optional name of the inbox. Displayed in the dashboard for easier search
...
/*
CreateInboxWithOptions Create an inbox with additional options
...
/*
GetExpiredInboxRecordById Get an expired inbox record
...
*/
func (a *InboxControllerApiService) GetExpiredInboxRecordById(ctx _context.Context, expiredId string) (ExpiredInboxDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/expired-records/{expiredId}"
...
/*
GetExpiredInboxRecordByInboxId Get expired inbox record for a previously existing inbox
Use the inboxId to return an ExpiredInboxRecord if an inbox has expired. Inboxes expire and are disabled if an expiration date is set or plan requires. Returns 404 if no expired inbox is found for the inboxId
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param inboxId ID of inbox you want to retrieve (not the inbox ID)
@return ExpiredInboxDto
*/
func (a *InboxControllerApiService) GetExpiredInboxRecordByInboxId(ctx _context.Context, inboxId string) (ExpiredInboxDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/{inboxId}/expired-record"
	localVarPath = strings.Replace(localVarPath, "{"+"inboxId"+"}", _neturl.QueryEscape(parameterToString(inboxId, "")) , -1)
...
// GetExpiredInboxRecordsOpts Optional parameters for the method 'GetExpiredInboxRecords'
type GetExpiredInboxRecordsOpts struct {
    Page optional.Int32
    Size optional.Int32
    Sort optional.String
}
...
/*
GetExpiredInboxRecords List records of expired inboxes
Inboxes created with an expiration date will expire after the given date. An ExpiredInboxRecord is created that records the inboxes old ID and email address. You can still read emails in the inbox (using the inboxes old ID) but the email address associated with the inbox can no longer send or receive emails. Fetch expired inbox records to view the old inboxes properties
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetExpiredInboxRecordsOpts - Optional Parameters:
...
*/
func (a *InboxControllerApiService) GetExpiredInboxRecords(ctx _context.Context, localVarOptionals *GetExpiredInboxRecordsOpts) (PageExpiredInboxRecordProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/inboxes/expired-records"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

 ...
 * @param "CreatedEarliestTime" (optional.Time) -  createdEarliestTime
 * @param "CreatedOldestTime" (optional.Time) -  createdOldestTime
 * @param "ExcludePreviouslyExported" (optional.Bool) -  excludePreviouslyExported
 * @param "Filter" (optional.String) -  filter
 * @param "ListSeparatorToken" (optional.String) -  listSeparatorToken
@return string
*/
func (a *ExportControllerApiService) ExportEntities(ctx _context.Context, apiKey string, exportType string, outputFormat string, localVarOptionals *ExportEntitiesOpts) (string, *_nethttp.Response, error) {
	var (
 ...
 * @param "ApiKey" (optional.String) -  apiKey
@return ExportLink
*/

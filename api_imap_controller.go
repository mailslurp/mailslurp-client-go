...
*/
func (a *ImapControllerApiService) ImapServerFetch(ctx _context.Context, seqNum int32, localVarOptionals *ImapServerFetchOpts) (ImapServerFetchResult, *_nethttp.Response, error) {
	var (

...
*/
func (a *InboxRulesetControllerApiService) GetInboxRulesets(ctx _context.Context, localVarOptionals *GetInboxRulesetsOpts) (PageInboxRulesetProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageInboxRulesetProjection
	)

...
@return PhoneNumberDto
*/
func (a *PhoneControllerApiService) GetPhoneNumberByName(ctx _context.Context) (PhoneNumberDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
@return PhoneNumberDto
*/
func (a *PhoneControllerApiService) GetPhoneNumberByPhoneNumber(ctx _context.Context) (PhoneNumberDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string

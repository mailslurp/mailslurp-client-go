...
/*
AcquirePhonePoolLease Acquire phone pool lease
...
func (a *PhoneControllerApiService) AcquirePhonePoolLease(ctx _context.Context, poolId string, acquirePhonePoolLeaseOptions AcquirePhonePoolLeaseOptions) (PhonePoolLeaseDto, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  PhonePoolLeaseDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}/leases"
	...
	// body params
	localVarPostBody = &acquirePhonePoolLeaseOptions
	if ctx != nil {
...
/*
AddAllPhoneNumbersToPhonePool Add all phone numbers to phone pool
...
func (a *PhoneControllerApiService) AddAllPhoneNumbersToPhonePool(ctx _context.Context, poolId string) (PhonePoolDetailDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhonePoolDetailDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}/numbers/add-all"
	localVarPath = strings.Replace(localVarPath, "{"+"poolId"+"}", _neturl.QueryEscape(parameterToString(poolId, "")) , -1)
...
/*
AddPhoneNumberTags Add phone number tags
...
func (a *PhoneControllerApiService) AddPhoneNumberTags(ctx _context.Context, phoneNumberId string, phoneNumberTagsOptions PhoneNumberTagsOptions) (PhoneNumberDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/numbers/{phoneNumberId}/tags"
	...
	// body params
	localVarPostBody = &phoneNumberTagsOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
AddPhoneNumbersToPhonePool Add phone numbers to phone pool
...
func (a *PhoneControllerApiService) AddPhoneNumbersToPhonePool(ctx _context.Context, poolId string, addPhonePoolNumbersOptions AddPhonePoolNumbersOptions) (PhonePoolDetailDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}/numbers"
	localVarPath = strings.Replace(localVarPath, "{"+"poolId"+"}", _neturl.QueryEscape(parameterToString(poolId, "")) , -1)
	...
	// body params
	localVarPostBody = &addPhonePoolNumbersOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
CreatePhonePool Create phone pool
...
func (a *PhoneControllerApiService) CreatePhonePool(ctx _context.Context, createPhonePoolOptions CreatePhonePoolOptions) (PhonePoolDetailDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &createPhonePoolOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
CreatePhoneProvisioningJob Create a phone provisioning job
...
func (a *PhoneControllerApiService) CreatePhoneProvisioningJob(ctx _context.Context, createPhoneProvisioningJobOptions CreatePhoneProvisioningJobOptions) (PhoneProvisioningJobDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneProvisioningJobDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/provisioning/jobs"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &createPhoneProvisioningJobOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
DeleteAllPhoneNumber Delete all phone numbers
...
/*
DeletePhoneMessageThreadItems Delete messages in a phone thread
...
/*
DeletePhonePool Delete phone pool
...
func (a *PhoneControllerApiService) DeletePhonePool(ctx _context.Context, poolId string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}"
	localVarPath = strings.Replace(localVarPath, "{"+"poolId"+"}", _neturl.QueryEscape(parameterToString(poolId, "")) , -1)
...
/*
GetAllPhoneNumberReleases Get all phone number releases
...
*/
func (a *PhoneControllerApiService) GetAllPhoneNumberReleases(ctx _context.Context, localVarOptionals *GetAllPhoneNumberReleasesOpts) (PagePhoneNumberReleaseProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PagePhoneNumberReleaseProjection
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/releases"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetOrCreatePhonePool Get or create phone pool
...
func (a *PhoneControllerApiService) GetOrCreatePhonePool(ctx _context.Context, getOrCreatePhonePoolOptions GetOrCreatePhonePoolOptions) (PhonePoolDetailDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/get-or-create"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &getOrCreatePhonePoolOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
GetPhoneNumberLineTypeIntelligence Get line type intelligence for a phone number
...
func (a *PhoneControllerApiService) GetPhoneNumberLineTypeIntelligence(ctx _context.Context, validatePhoneNumberOptions ValidatePhoneNumberOptions) (PhoneNumberLineTypeLookupDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneNumberLineTypeLookupDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/validate/line-type-intelligence"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetPhoneNumberRelease Get phone number release
Get a released or deleted phone numbers
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param releaseId
@return PhoneNumberReleaseProjection
*/
func (a *PhoneControllerApiService) GetPhoneNumberRelease(ctx _context.Context, releaseId string) (PhoneNumberReleaseProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneNumberReleaseProjection
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/releases/{releaseId}"
...
/*
GetPhoneNumberTags Get phone number tags
...
func (a *PhoneControllerApiService) GetPhoneNumbers(ctx _context.Context, localVarOptionals *GetPhoneNumbersOpts) (PagePhoneNumberProjection, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.LineType.IsSet() {
		localVarQueryParams.Add("lineType", parameterToString(localVarOptionals.LineType.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.CarrierName.IsSet() {
		localVarQueryParams.Add("carrierName", parameterToString(localVarOptionals.CarrierName.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.MobileCountryCode.IsSet() {
		localVarQueryParams.Add("mobileCountryCode", parameterToString(localVarOptionals.MobileCountryCode.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.MobileNetworkCode.IsSet() {
		localVarQueryParams.Add("mobileNetworkCode", parameterToString(localVarOptionals.MobileNetworkCode.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.ProviderLabel.IsSet() {
		localVarQueryParams.Add("providerLabel", parameterToString(localVarOptionals.ProviderLabel.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.Page.IsSet() {
		localVarQueryParams.Add("page", parameterToString(localVarOptionals.Page.Value(), ""))
	}
...
/*
GetPhonePool Get phone pool
Get phone pool details by ID
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param poolId
@return PhonePoolDetailDto
*/
func (a *PhoneControllerApiService) GetPhonePool(ctx _context.Context, poolId string) (PhonePoolDetailDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
/*
GetPhonePoolByName Get phone pool by name
Get phone pool details by name
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param name
@return PhonePoolDetailDto
*/
func (a *PhoneControllerApiService) GetPhonePoolByName(ctx _context.Context, name string) (PhonePoolDetailDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/by-name"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetPhonePools Get phone pools
List phone pools for the authenticated user
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []PhonePoolDto
*/
func (a *PhoneControllerApiService) GetPhonePools(ctx _context.Context) ([]PhonePoolDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []PhonePoolDto
	)
...
/*
GetPhoneProvisioningCapabilities Get phone provisioning capabilities
...
func (a *PhoneControllerApiService) GetPhoneProvisioningCapabilities(ctx _context.Context, phoneCountry string, localVarOptionals *GetPhoneProvisioningCapabilitiesOpts) (PhoneProviderCapabilitiesResult, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneProviderCapabilitiesResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/provisioning/capabilities"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

	localVarQueryParams.Add("phoneCountry", parameterToString(phoneCountry, ""))
	if localVarOptionals != nil && localVarOptionals.ProviderLabel.IsSet() {
		localVarQueryParams.Add("providerLabel", parameterToString(localVarOptionals.ProviderLabel.Value(), ""))
	}
	// to determine the Content-Type header
...
/*
GetPhoneProvisioningJob Get phone provisioning job
...
func (a *PhoneControllerApiService) GetPhoneProvisioningJob(ctx _context.Context, jobId string) (PhoneProvisioningJobDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/provisioning/jobs/{jobId}"
...
/*
GetPhoneSmsPrepaidCredit Get SMS prepaid credit
...
func (a *PhoneControllerApiService) GetPhoneSmsPrepaidCredit(ctx _context.Context, creditId string) (PhoneSmsPrepaidCreditDto, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneSmsPrepaidCreditDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/sms-prepaid-credits/{creditId}"
	localVarPath = strings.Replace(localVarPath, "{"+"creditId"+"}", _neturl.QueryEscape(parameterToString(creditId, "")) , -1)
...
/*
GetPhoneSmsPrepaidCredits Get SMS prepaid credits
List SMS prepaid credits for the authenticated account
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return PhoneSmsPrepaidCreditsDto
*/
func (a *PhoneControllerApiService) GetPhoneSmsPrepaidCredits(ctx _context.Context) (PhoneSmsPrepaidCreditsDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneSmsPrepaidCreditsDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/sms-prepaid-credits"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
GetPhoneSummary Get phone summary
Get overview of assigned phones
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return PhoneSummaryDto
*/
func (a *PhoneControllerApiService) GetPhoneSummary(ctx _context.Context) (PhoneSummaryDto, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PhoneSummaryDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/summary"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
func (a *PhoneControllerApiService) GetPhoneTags(ctx _context.Context, localVarOptionals *GetPhoneTagsOpts) ([]string, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/tags"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
ReassignPhoneNumberRelease Reassign phone number release
...
func (a *PhoneControllerApiService) ReassignPhoneNumberRelease(ctx _context.Context, releaseId string) (PhoneNumberDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/releases/{releaseId}/reassign"
	localVarPath = strings.Replace(localVarPath, "{"+"releaseId"+"}", _neturl.QueryEscape(parameterToString(releaseId, "")) , -1)
...
/*
ReleasePhonePoolLease Release phone pool lease
...
func (a *PhoneControllerApiService) ReleasePhonePoolLease(ctx _context.Context, poolId string, leaseId string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}/leases/{leaseId}"
	localVarPath = strings.Replace(localVarPath, "{"+"poolId"+"}", _neturl.QueryEscape(parameterToString(poolId, "")) , -1)

	localVarPath = strings.Replace(localVarPath, "{"+"leaseId"+"}", _neturl.QueryEscape(parameterToString(leaseId, "")) , -1)
...
/*
RemovePhoneNumberFromPhonePool Remove phone number from phone pool
...
func (a *PhoneControllerApiService) RemovePhoneNumberFromPhonePool(ctx _context.Context, poolId string, phoneNumberId string) (*_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/pools/{poolId}/numbers/{phoneNumberId}"
	localVarPath = strings.Replace(localVarPath, "{"+"poolId"+"}", _neturl.QueryEscape(parameterToString(poolId, "")) , -1)
...
/*
RemovePhoneNumberTags Remove phone number tags
...
/*
SearchAvailablePhoneNumbers Search available phone numbers
...
func (a *PhoneControllerApiService) SearchAvailablePhoneNumbers(ctx _context.Context, searchAvailablePhoneNumbersOptions SearchAvailablePhoneNumbersOptions) (AvailablePhoneNumbersResult, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  AvailablePhoneNumbersResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/phone/provisioning/search"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &searchAvailablePhoneNumbersOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
SetPhoneNumberTags Set phone number tags
...
/*
UpdatePhonePool Update phone pool
...
func (a *PhoneControllerApiService) UpdatePhonePool(ctx _context.Context, poolId string, updatePhonePoolOptions UpdatePhonePoolOptions) (PhonePoolDetailDto, *_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = &updatePhonePoolOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

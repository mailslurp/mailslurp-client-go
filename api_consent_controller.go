...
func (a *ConsentControllerApiService) CheckSendingConsentForEmailAddress(ctx _context.Context, emailAddress string) (OptInSendingConsentDto, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  OptInSendingConsentDto
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/consent/opt-in/sending-consent"
...
*/
func (a *ConsentControllerApiService) GetOptInIdentities(ctx _context.Context, localVarOptionals *GetOptInIdentitiesOpts) (PageOptInIdentityProjection, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  PageOptInIdentityProjection
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/consent/opt-in"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
...
/*
SendOptInConsentForEmailAddress Send a verification code to a user once they have explicitly submitted their email address
...
func (a *ConsentControllerApiService) SendOptInConsentForEmailAddress(ctx _context.Context, optInConsentOptions OptInConsentOptions) (OptInConsentSendResult, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  OptInConsentSendResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/consent/opt-in/send"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &optInConsentOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

...
/*
WaitForMatchingFirstEmail Wait for or return the first email that matches proved MatchOptions array
...
/*
WaitForNthEmail Wait for or fetch the email with a given index in the inbox specified. IF indx doesn't exist waits for it to exist or timeout to occur.

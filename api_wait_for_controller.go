...
/*
WaitForLatestSms Wait for the latest SMS message to match the provided filter conditions such as body contains keyword.
...
func (a *WaitForControllerApiService) WaitForLatestSms(ctx _context.Context, waitForSingleSmsOptions WaitForSingleSmsOptions) (SmsDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/waitForLatestSms"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &waitForSingleSmsOptions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
WaitForSms Wait for an SMS message to match the provided filter conditions such as body contains keyword.
...
func (a *WaitForControllerApiService) WaitForSms(ctx _context.Context, waitForSmsConditions WaitForSmsConditions) ([]SmsPreview, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  []SmsPreview
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/waitForSms"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	...
	// body params
	localVarPostBody = &waitForSmsConditions
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string

 ...
 * @param "WaitForConditions" (optional.Interface of WaitForConditions) -  Conditions to apply to emails that you are waiting for
@return []EmailPreview
*/
 ...
 * @param "Count" (optional.Int32) -  Number of emails to wait for. Must be greater or equal to 1
 * @param "Delay" (optional.Int64) -  Max milliseconds delay between calls
 * @param "InboxId" (optional.Interface of string) -  Id of the inbox we are fetching emails from
 * @param "Since" (optional.Time) -  Filter for emails that were received after the given timestamp
 * @param "Sort" (optional.String) -  Sort direction
...
@return []EmailPreview
*/
func (a *WaitForControllerApiService) WaitForMatchingEmails(ctx _context.Context, matchOptions MatchOptions, localVarOptionals *WaitForMatchingEmailsOpts) ([]EmailPreview, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
 ...
 * @param "Delay" (optional.Int64) -  Max milliseconds delay between calls
 * @param "InboxId" (optional.Interface of string) -  Id of the inbox we are matching an email for
 * @param "Since" (optional.Time) -  Filter for emails that were received after the given timestamp
 * @param "Sort" (optional.String) -  Sort direction
 * @param "Timeout" (optional.Int64) -  Max milliseconds to wait
 * @param "UnreadOnly" (optional.Bool) -  Optional filter for unread only
@return Email
*/
func (a *WaitForControllerApiService) WaitForMatchingFirstEmail(ctx _context.Context, matchOptions MatchOptions, localVarOptionals *WaitForMatchingFirstEmailOpts) (Email, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string

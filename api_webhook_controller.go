...
/*
CreateWebhookForAITransformer Attach a WebHook URL to an AI transformer
...
func (a *WebhookControllerApiService) CreateWebhookForAITransformer(ctx _context.Context, transformerId string, createWebhookOptions CreateWebhookOptions) (WebhookDto, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/ai-transformers/{transformerId}/webhooks"
	localVarPath = strings.Replace(localVarPath, "{"+"transformerId"+"}", _neturl.QueryEscape(parameterToString(transformerId, "")) , -1)
...
func (a *WebhookControllerApiService) GetAllWebhookResults(ctx _context.Context, localVarOptionals *GetAllWebhookResultsOpts) (PageWebhookResult, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.AiTransformerId.IsSet() {
		localVarQueryParams.Add("aiTransformerId", parameterToString(localVarOptionals.AiTransformerId.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *WebhookControllerApiService) GetAllWebhooks(ctx _context.Context, localVarOptionals *GetAllWebhooksOpts) (PageWebhookProjection, *_nethttp.Response, error) {
	...
	if localVarOptionals != nil && localVarOptionals.EventTypeSource.IsSet() {
		localVarQueryParams.Add("eventTypeSource", parameterToString(localVarOptionals.EventTypeSource.Value(), ""))
	}
	if localVarOptionals != nil && localVarOptionals.IncludeAccountWide.IsSet() {
		localVarQueryParams.Add("includeAccountWide", parameterToString(localVarOptionals.IncludeAccountWide.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *WebhookControllerApiService) GetTestWebhookPayloadNewAITransformResult(ctx _context.Context) (WebhookNewAiTransformResultPayload, *_nethttp.Response, error) {
	var (
		...
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  WebhookNewAiTransformResultPayload
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/webhooks/test/new-ai-transform-result-payload"
	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}

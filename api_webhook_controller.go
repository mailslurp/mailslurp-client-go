...
/*
GetJsonSchemaForWebhookPayload Get JSON Schema definition for webhook payload
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param webhookId webhookId
...
/*
GetTestWebhookPayloadEmailOpened Get webhook test payload for email opened event
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetTestWebhookPayloadEmailRead Get webhook test payload for email opened event
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
/*
GetTestWebhookPayloadForWebhook Get example payload for webhook
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param webhookId webhookId
@return AbstractWebhookPayload
*/

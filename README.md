...
- [Full method documentation](https://docs.mailslurp.com/go/docs/)
- [Examples](https://www.mailslurp.com/examples/)
- [Guides](https://www.mailslurp.com/guides/)

### Common controllers

- [EmailController](https://docs.mailslurp.com/go/docs/EmailControllerApi/) to send and receive emails
- [InboxController](https://docs.mailslurp.com/go/docs/InboxControllerApi/) create email addresses
- [WaitForController](https://docs.mailslurp.com/go/docs/WaitForControllerApi/) wait for emails to arrive
...
Use the [InboxController](https://docs.mailslurp.com/go/docs/InboxControllerApi/) to manage inboxes. You can create email addresses in MailSlurp by creating an inbox:
...
To send emails first create an inbox then use the [SendEmailOptions](https://docs.mailslurp.com/go/docs/SendEmailOptions/) to configure the email.
...
You can read emails in Go using the [WaitForControllerApi](https://docs.mailslurp.com/go/docs/WaitForControllerApi/):
...
Attachments can be sent by first uploading an attachment then using the returned ID with send email options. See the [AttachmentController](https://docs.mailslurp.com/go/docs/AttachmentControllerApi/) to manage attachments.

...
- [Full method documentation](https://mailslurp.github.io/mailslurp-client-go/)
- [Examples](https://www.mailslurp.com/examples/)
- [Guides](https://www.mailslurp.com/guides/)

### Common controllers

- [EmailController](https://mailslurp.github.io/mailslurp-client-go/#EmailControllerApiService) to send and receive emails
- [InboxController](https://mailslurp.github.io/mailslurp-client-go/#InboxControllerApiService) create email addresses
- [WaitForController](https://mailslurp.github.io/mailslurp-client-go/#WaitForControllerApiService) wait for emails to arrive
...
See the [Method Documentation](https://docs.mailslurp.com/go/docs/) for more information or see the use cases below.
...
Use the [InboxController](https://mailslurp.github.io/mailslurp-client-go/#InboxControllerApiService) to manage inboxes. You can create email addresses in MailSlurp by creating an inbox:
...
To send emails first create an inbox then use the [SendEmailOptions](https://mailslurp.github.io/mailslurp-client-go/#SendEmailOptions) to configure the email.
...
You can read emails in Go using the [WaitForControllerApi](https://mailslurp.github.io/mailslurp-client-go/#WaitForControllerApiService):
...
Attachments can be sent by first uploading an attachment then using the returned ID with send email options. See the [AttachmentController](https://mailslurp.github.io/mailslurp-client-go/#AttachmentControllerApiService) to manage attachments.

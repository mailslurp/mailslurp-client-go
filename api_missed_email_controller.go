...
@return MissedEmail
*/
func (a *MissedEmailControllerApiService) WaitForNthMissedEmail(ctx _context.Context, inboxId string, timeout int64, localVarOptionals *WaitForNthMissedEmailOpts) (MissedEmail, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localVarPath = strings.Replace(localVarPath, "{"+"timeout"+"}", _neturl.QueryEscape(parameterToString(timeout, "")) , -1)
